...
public class SimpleJoinTransformationExample3 {
	public static void main(String[] args) {
		...
		JavaRDD<String> whiteListRdd = jsc
				.textFile("/Users/antiwari/Documents/Epsilon/Machine-Intelligence/MI_Docs/While-Black List Sample Files/whitelistScoring.csv");
		...
		System.out.println("Collect: "+bb.collect());
